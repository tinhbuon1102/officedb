...
(function($) {
	...
	$.CrellySlider = function(target, settings) {
		...
		function init() {
			...
			setPreloader();
			/**/
			getSlide(0).addClass("active-slide");
			getSlide(0).find('.sword').addClass("active");
			/**/
		...
		function getNextSlide() {
			getSlide(current_slide).removeClass("active-slide");
			getSlide(current_slide).find('.sword').removeClass("active");
			if(current_slide + 1  == total_slides) {
			getSlide(0).addClass("active-slide");
			getSlide(0).find('.sword').addClass("active");
				return 0;
			}
						getSlide(current_slide + 1).addClass("active-slide");
			getSlide(current_slide + 1).find('.sword').addClass("active");
		...
		function getPreviousSlide() {
			...
			getSlide(total_slides - 1).addClass("active-slide");
			getSlide(total_slides - 1).find('.sword').addClass("active");
