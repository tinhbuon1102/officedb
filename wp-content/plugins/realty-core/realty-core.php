...
if (!is_admin()) {
	...
	require_once REALTY_CORE_PLUGIN_DIR_URL . 'shortcodes/shortcode-news-list.php';
	require_once REALTY_CORE_PLUGIN_DIR_URL . 'shortcodes/shortcode-property-core-section.php';
