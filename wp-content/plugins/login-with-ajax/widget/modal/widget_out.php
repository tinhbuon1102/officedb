					...
					<table>
		                ...
		                <tr class="lwa-email">
		                    <td>
		                        ...
		                        <input type="text" name="user_email" id="user_email" class="input" <?php echo @$_SESSION['realty_custom_order'][3]['custom_order_customer_email']?>/>
		                        </label>
		                    </td>
		                </tr>
		                <tr class="lwa-username">
		                    <td>
		                        ...
		                        <input type="text" name="user_login" id="user_login" class="input" value="<?php echo @$_SESSION['realty_custom_order'][3]['custom_order_customer_email']?>" />
		                        </label>
		                    </td>
		                </tr>
		                <tr class="lwa-password">
