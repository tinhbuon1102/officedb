...
class TP_Image_Optimizer_List_Table extends WP_List_Table {
    ...
    function get_columns() {
        $columns = array(
            ...
            'mime'         => esc_html__('Type', 'tp-image-optimizer'),
            'origin_size'  => esc_html__('Original Size', 'tp-image-optimizer'),
            'current_size' => esc_html__('Current Size', 'tp-image-optimizer'),
            'optimizer'    => esc_html__('Optimizer', 'tp-image-optimizer') .'<span class="faq-i faq-stastics_original"></span>',
            'detail'       => esc_html__('Detail', 'tp-image-optimizer'),
        );
        return $columns;
    }
