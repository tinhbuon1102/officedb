...
if (!class_exists('TP_Image_Optimizer_Table')) {
    ...
    class TP_Image_Optimizer_Table {
        ...
        /**
         * Get total size of attachment
         * 
         * @return double Total of origin size image attachment
         * @since 1.0.0
         */
        public function get_total_origin_size() {
            ...
            foreach ($results as $result) {
                $total_size = $total_size + $result->origin_size;
            }
            return $total_size;
        }
        ...
        public function count_list_optimize_image() {
            ...
            if (!$force) {
                // Get pending or eror image to compress
        ...
        /**
         * Get stastics of images with size name
         * 
         * @param String $attachment_id ID of attachment
         * @param String $size_name Size name of attachment 
         * @since 1.0.0
         */
        public function get_all_stastic_image($attachment_id, $size_name) {
            global $wpdb;
            $stastics   = array();
        ...
        public function count_optimize_image($force) {
            ...
            if (!$force) {
                // Get pending or eror image to compress
                $total_pre_compress = $wpdb->get_var("SELECT COUNT(*) FROM $this->db WHERE ((`status`='pending') OR (`status`='error')) AND `size_name`='full' ORDER BY `id` ASC ");
            }
