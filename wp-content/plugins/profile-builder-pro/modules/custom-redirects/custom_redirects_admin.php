...
function wppb_add_content_before_custom_redirects_info(){
	...
	<ol>
		...
		<li><?php _e("Individual redirects defined in shortcodes or in the Multiple Registration and Edit Profile form settings. (<strong><em>redirect_priority=\"top\"</em></strong> parameter can be added in any shortcode, then that shortcode redirect will have priority over all other redirects)", 'profile-builder'); ?></li>
	</ol>
	<hr/>
