jQuery(document).ready(function(jQuery) {
	...
	function changeTemplate() {
		...
		// xxx-realty-3-notifications
		if( pageTemplate == 'template-agents.php' ) {
			jQuery('.page-template-agents-notification').removeClass('hide');
		} else {
			jQuery('.page-template-agents-notification').addClass('hide');
		}

		if( pageTemplate == 'template-contact.php' ) {
			jQuery('.page-template-contact-notification').removeClass('hide');
		} else {
			jQuery('.page-template-contact-notification').addClass('hide');
		}

		if( pageTemplate == 'template-intro.php' ) {
			jQuery('.page-template-intro-notification').removeClass('hide');
		} else {
			jQuery('.page-template-intro-notification').addClass('hide');
		}

		if( pageTemplate == 'template-subscription-packages.php' ) {
			jQuery('.page-template-subscription-packages-notification').removeClass('hide');
		} else {
			jQuery('.page-template-subscription-packages-notification').addClass('hide');
		}

		if( pageTemplate == 'template-home-properties-map.php' ) {
			jQuery('.page-template-property-map-notification').removeClass('hide');
		} else {
			jQuery('.page-template-property-map-notification').addClass('hide');
		}

		if( pageTemplate == 'template-property-search.php' ) {
			jQuery('.page-template-property-search-notification').removeClass('hide');
		} else {
			jQuery('.page-template-property-search-notification').addClass('hide');
		}

		if( pageTemplate == 'template-slideshow.php' ) {
			jQuery('.page-template-slideshow-notification').removeClass('hide');
		} else {
			jQuery('.page-template-slideshow-notification').addClass('hide');
		}
