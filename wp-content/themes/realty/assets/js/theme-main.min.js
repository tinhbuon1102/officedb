...
t("#content").css("margin-top",i+"px")}/* Smooth Scroll Menu Links
		-------------------------*/
t('#up i, .property-header a[href="#location_map"]').on("click",function(e){e.preventDefault(),t("html,body").animate({scrollTop:t(this.hash).offset().top-15},800)}),/* Scroll To The Top - Button
		-------------------------*/
...
t("body").hasClass("admin-bar")?(t("header.navbar").removeClass("mini"),t("header.navbar").css("top","32px")):(t("header.navbar").removeClass("mini"),t("header.navbar").css("top",0)))}),/* Bootstrap Plugins
		-------------------------*/
t('[data-toggle="tooltip"]').tooltip({container: 'body'})}),t(window).load(function(){/* Chosen.js - Custom Select Boxes
