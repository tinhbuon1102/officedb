...
<div class="<?php echo $classes; ?> clearfix"<?php if ( isset ( $property_counter ) ) { echo ' data-sync-id="' . esc_attr( $property_counter ) . '"'; }?>>
<div class="property-title bestview-name">
			<a href="<?php echo get_permalink( $post ); ?>"><h3 class="title"><?php echo $post_title; ?></h3></a>
		</div>
<div class="widget_view_listing_image">
...
</div><!--/widget_view_listing_image-->
	<div class="property-content content listing_name_right">
