...
div#content{margin-top:0;padding-top:40px;}
...
@media print{
body{font-family:Georgia,serif!important;font-size:10pt;color:#000;}
...
h4{font-family:"Source Sans Pro";font-weight:400;color:#42484b;opacity:1;visibility:visible;-webkit-transition:opacity .24s ease-in-out;-moz-transition:opacity .24s ease-in-out;transition:opacity .24s ease-in-out;}
h4{opacity:0;}
h4{visibility:hidden;}
body{font-family:"Fira Sans";font-weight:400;color:#787878;opacity:1;visibility:visible;-webkit-transition:opacity .24s ease-in-out;-moz-transition:opacity .24s ease-in-out;transition:opacity .24s ease-in-out;}
.btn-primary,.btn-primary:focus,input[type='submit']{background-color:#000;}
input:focus,.form-control:focus,input:active,.form-control:active,.chosen-container .chosen-drop{border-color:#000;}
.top-header,.top-header a,.site-branding,.site-title a,.primary-menu a{color:#000;}
body{color:#3b3b3b;color:#000;font-size:14px;font-style:normal;font-weight:normal;background-color:#fff;line-height:1.4;font-family:"游ゴシック",YuGothic,"ヒラギノ角ゴ Pro","Hiragino Kaku Gothic Pro","メイリオ","Meiryo",sans-serif;}
.top-header a{color:#787878;}
h4{color:#000;}
/*! CSS Used from: premium-office.net/wp-content/cache/autoptimize/css/autoptimize_f7044a4567c7cdb32c958c2d0003ba0b.css */
...
.crellyslider>.cs-controls{position:absolute;width:100%;top:50%;margin-top:-9px;}
.crellyslider>.cs-controls>.cs-previous,.crellyslider>.cs-controls>.cs-next{display:block;width:35px;height:35px;position:absolute;cursor:pointer;background-color:#fff;box-shadow:0 3px 10px rgba(0,0,0,0.16),0 3px 10px rgba(0,0,0,0.23);background-repeat:no-repeat;background-position:center center;border:10px;border-radius:50%;}
.crellyslider>.cs-controls>.cs-previous{background-image:url(/wp-content/plugins/crelly-slider/css/../images/arrow-left.png);left:30px;}
.crellyslider>.cs-controls>.cs-next{background-image:url(/wp-content/plugins/crelly-slider/css/../images/arrow-right.png);right:30px;}
.crellyslider>.cs-navigation{position:absolute;width:100%;height:0;bottom:40px;text-align:center;}
.crellyslider>.cs-navigation>.cs-slide-link{width:15px;height:15px;display:inline-block;cursor:pointer;margin:6px;background-color:#fff;box-shadow:0 3px 10px rgba(0,0,0,0.16),0 3px 10px rgba(0,0,0,0.23);border:10px;border-radius:50%;opacity:.5;filter:alpha(opacity=50);}
.crellyslider>.cs-navigation>.cs-slide-link.cs-active{opacity:1;filter:alpha(opacity=100);}
.crellyslider>.cs-progress-bar{width:0;height:4px;position:absolute;top:0;background-color:#fff;opacity:.5;filter:alpha(opacity=50);z-index:999;}
...
.chosen-container-single .chosen-single span{display:block;overflow:hidden;margin-right:26px;text-overflow:ellipsis;white-space:nowrap;}
.chosen-container-single .chosen-single div{position:absolute;top:0;right:0;display:block;width:18px;height:100%;}
.chosen-container-single .chosen-single div b{display:block;width:100%;height:100%;background:url(/wp-content/themes/realty/assets/css/chosen-sprite.png) 0 2px no-repeat;}
.chosen-container-single .chosen-search{position:relative;z-index:1010;margin:0;padding:3px 4px;white-space:nowrap;}
.chosen-container-single .chosen-search input[type=text]{box-sizing:border-box;margin:1px 0;padding:4px 20px 4px 5px;width:100%;height:auto;outline:0;border:1px solid #aaa;background:url(/wp-content/themes/realty/assets/css/chosen-sprite.png) 100% -20px no-repeat;font-size:1em;font-family:sans-serif;line-height:normal;border-radius:0;}
.chosen-container-single .chosen-drop{margin-top:-1px;border-radius:0 0 4px 4px;background-clip:padding-box;}
.chosen-container .chosen-results{position:relative;overflow-x:hidden;overflow-y:auto;margin:0 4px 4px 0;padding:0 0 0 4px;max-height:240px;-webkit-overflow-scrolling:touch;}
@media only screen and (-webkit-min-device-pixel-ratio:2),only screen and (-webkit-min-device-pixel-ratio:1.5),only screen and (min-resolution:144dpi){
.chosen-container-single .chosen-search input[type=text],.chosen-container-single .chosen-single div b{background-image:url(/wp-content/themes/realty/assets/css/chosen-sprite@2x.png)!important;background-size:52px 37px!important;background-repeat:no-repeat!important;}
}
...
/*! CSS Used from: premium-office.net/wp-content/cache/autoptimize/css/autoptimize_e555493c25a70571f51d2d12b913a8e1.css */
a{background-color:transparent;}
a:active,a:hover{outline-width:0;}
.container{margin-right:auto;margin-left:auto;padding-left:15px;padding-right:15px;}
.container:before,.container:after{content:" ";display:table;}
...
.breadcrumbs{font-size:12px;line-height:40px;background:rgba(250,250,250,1);}
@media (min-width:1200px){
.container{width:1170px;}
}
@media (max-width:991px){
...
p{margin:0 0 1em;}
p:empty{margin:0;}
input,input[type=submit],input:focus{outline:0;width:100%;height:40px;line-height:40px;padding:0 1em;font-size:1em;color:#787878;border-radius:4px;border:1px solid #e6e6e6;-webkit-appearance:none;box-shadow:none;transition:all .2s;}
input[type=submit]{width:auto;color:#fff;border-color:transparent!important;}
input:hover{border-color:#e6e6e6;}
input:active,input:focus{border-color:#43becc;}
::-webkit-input-placeholder{color:#bbb!important;}
:-moz-placeholder{color:#bbb!important;}
::-moz-placeholder{color:#bbb!important;}
:-ms-input-placeholder{color:#bbb!important;}
...
a[href^=tel]{color:inherit;text-decoration:none;}
i{display:inline-block;font-style:normal;transition:all .2s;}
h1,h4{margin:0 0 1em;font-family:Lato,sans-serif;font-weight:400;line-height:1.3;text-rendering:optimizeLegibility;text-shadow:none;-webkit-font-smoothing:antialiased;}
h1{font-size:2.1em;margin-bottom:.8em;}
h4{font-size:1.4em;}
article h1,article h4{margin-top:1em;}
article h1:first-child,article h4:first-child{margin-top:0;}
p{margin:0 0 1em;}
p:empty{margin:0;}
input,input[type=submit],input:focus,textarea{outline:0;width:100%;height:40px;line-height:40px;padding:0 1em;font-size:1em;color:#787878;border-radius:4px;border:1px solid #e6e6e6;-webkit-appearance:none;box-shadow:none;transition:all .2s;}
input[type=submit]{width:auto;color:#fff;border-color:transparent!important;}
input:hover{border-color:#e6e6e6;}
input:active,input:focus{border-color:#43becc;}
textarea{display:block;outline:0;height:auto;width:100%;line-height:inherit;border-radius:0;-webkit-appearance:none;}
::-webkit-input-placeholder{color:#bbb!important;}
:-moz-placeholder{color:#bbb!important;}
::-moz-placeholder{color:#bbb!important;}
:-ms-input-placeholder{color:#bbb!important;}
...
.vc_column_container>.vc_column-inner{box-sizing:border-box;padding-left:15px;padding-right:15px;width:100%;}
.section-title span{background-color:#fff;}
h1,h4{font-family:"Source Sans Pro";font-weight:400;color:#42484b;opacity:1;visibility:visible;-webkit-transition:opacity .24s ease-in-out;-moz-transition:opacity .24s ease-in-out;transition:opacity .24s ease-in-out;}
h4{opacity:0;}
h4{visibility:hidden;}
input[type='submit']{background-color:#000;}
input:focus,input:active{border-color:#000;}
...
.row:before,.row:after{content:" ";display:table;}
.row:after{clear:both;}
.col-sm-4,.col-xs-12,.col-sm-12{position:relative;min-height:1px;padding-left:15px;padding-right:15px;}
.col-xs-12{float:left;}
.col-xs-12{width:100%;}
@media (min-width:768px){
...
.row:before,.row:after{content:" ";display:table;}
.row:after{clear:both;}
.col-xs-4,.col-sm-4,.col-md-4,.col-sm-6,.col-xs-12,.col-sm-12,.col-md-12,.col-lg-12{position:relative;min-height:1px;padding-left:15px;padding-right:15px;}
.col-xs-4,.col-xs-12{float:left;}
...
.clearfix:before,.clearfix:after{content:" ";display:table;}
.clearfix:after{clear:both;}
.list-unstyled{padding:0;list-style-type:none;}
.border-box{box-shadow:0 1px 2px 1px rgba(0,0,0,.15);transition:all .2s;}
.border-box:hover{box-shadow:0 1px 2px 1px rgba(0,0,0,.3);}
.border-box .content{background-color:#fbfbfb;}
a{outline:0;color:#43becc;text-decoration:none;transition:all .2s;}
a:hover,a:focus{color:#787878;text-decoration:none;}
a i{transition:all 0s;}
i{display:inline-block;font-style:normal;transition:all .2s;}
...
h2,h3{margin:0 0 1em;font-family:Lato,sans-serif;font-weight:400;line-height:1.3;text-rendering:optimizeLegibility;text-shadow:none;-webkit-font-smoothing:antialiased;}
h2{font-size:1.8em;margin-bottom:.8em;}
h3{font-size:1.6em;margin-bottom:.8em;}
ul{margin:0 0 1em;padding-left:20px;list-style-type:square;line-height:2;}
.form-group{margin-bottom:15px;}
select:not(.attachment-filters){position:relative;}
select:not(.attachment-filters).form-control{-webkit-appearance:none;-moz-appearance:none;appearance:none;box-shadow:none;}
select:not(.attachment-filters)::after{font-family:FontAwesome;content:"\F107";position:absolute;right:14px;top:14px;line-height:1;}
input,input[type=submit],input:focus,.chosen-container.chosen-container-single .chosen-single,select:not(.attachment-filters){outline:0;width:100%;height:40px;line-height:40px;padding:0 1em;font-size:1em;color:#787878;border-radius:4px;border:1px solid #e6e6e6;-webkit-appearance:none;box-shadow:none;transition:all .2s;}
input[type=checkbox]{height:auto;width:auto;margin-right:.5em;-webkit-appearance:checkbox;}
input[type=submit]{width:auto;color:#fff;border-color:transparent!important;}
input:hover,.form-control:hover{border-color:#e6e6e6;}
input:active,input:focus,.form-control:active,.form-control:focus{border-color:#43becc;}
::-webkit-input-placeholder{color:#bbb!important;}
...
.typeahead__field input[type="search"]::-ms-clear{display:none;width:0;height:0;}
.typeahead__cancel-button{visibility:hidden;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;border-radius:50%;width:16px;height:16px;position:absolute;top:8px;right:.8em;cursor:pointer;background:url(data:image/svg+xml;charset=utf8;base64,) no-repeat scroll center center transparent;}
[class*=" howcons-"]{font-family:'howcons'!important;speak:none;font-style:normal;font-weight:normal;font-variant:normal;text-transform:none;line-height:1;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;}
.howcons-clipboard-add2:before{content:"\e912";}
.chosen-container{position:relative;display:inline-block;vertical-align:middle;font-size:13px;zoom:1;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}
.chosen-container .chosen-drop{position:absolute;top:100%;left:-9999px;z-index:1010;box-sizing:border-box;width:100%;border:1px solid #aaa;border-top:0;background:#fff;box-shadow:0 4px 5px rgba(0,0,0,.15);}
.chosen-container a{cursor:pointer;}
.chosen-container-single .chosen-single{position:relative;display:block;overflow:hidden;padding:0 0 0 8px;height:23px;border:1px solid #aaa;border-radius:5px;background-color:#fff;background:linear-gradient(top,#fff 20%,#f6f6f6 50%,#eee 52%,#f4f4f4 100%);background-clip:padding-box;box-shadow:0 0 3px #fff inset,0 1px 1px rgba(0,0,0,.1);color:#444;text-decoration:none;white-space:nowrap;line-height:24px;}
...
[class^=icon-]:before{font-family:realty!important;font-style:normal!important;font-weight:400!important;font-variant:normal!important;text-transform:none!important;speak:none;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;}
.icon-facebook:before{content:"\28";}
.icon-google-plus:before{content:"\29";}
.icon-pinterest:before{content:"\2b";}
.icon-twitter:before{content:"\2c";}
.icon-share:before{content:"\60";}
[class^="iconmoon-"]{font-family:'iconmoon'!important;speak:none;font-style:normal;font-weight:normal;font-variant:normal;text-transform:none;line-height:1;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;}
.iconmoon-location:before{content:"\e903";}
.iconmoon-crop_free:before{content:"\e3c2";}
.iconmoon-directions_transit:before{content:"\e535";}
*{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;}
*:before,*:after{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;}
input,input[type=submit],input:focus,.chosen-container.chosen-container-single .chosen-single,select:not(.attachment-filters){border-radius:0;}
@media (min-width:992px){
...
.col-md-4.search-container h2{font-family:Didot,"DidotW01-Italic","Didot LT STD","Hoefler Text",Garamond,"Times New Roman",serif;color:#000;}
...
a{color:#000;}
h2,h3{font-family:"Source Sans Pro";font-weight:400;color:#42484b;opacity:1;visibility:visible;-webkit-transition:opacity .24s ease-in-out;-moz-transition:opacity .24s ease-in-out;transition:opacity .24s ease-in-out;}
h2,h3{opacity:0;}
h2,h3{visibility:hidden;}
input[type='submit']{background-color:#000;}
input:focus,.form-control:focus,input:active,.form-control:active,.chosen-container .chosen-drop{border-color:#000;}
.property-item .property-title::after{background:none;}
.property-item .property-title .title{color:#000;}
h2,h3{color:#000;}
@media print{
a{color:#000!important;}
a[href]:after{content:none;}
.add-to-favorites{display:none!important;}
}
.fa{display:inline-block;font:normal normal normal 14px/1 FontAwesome;font-size:inherit;text-rendering:auto;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;}
.fa-star:before{content:"\f005";}
.fa-star-o:before{content:"\f006";}
/*! CSS Used from: premium-office.net/wp-content/cache/autoptimize/css/autoptimize_b8a4d5f1027472e058385d424ea5ead2.css */
...
.row:before,.row:after{content:" ";display:table;}
.row:after{clear:both;}
.col-xs-4,.col-sm-4,.col-md-4,.col-xs-6,.col-sm-6,.col-md-8,.col-xs-12,.col-sm-12,.col-md-12,.col-lg-12{position:relative;min-height:1px;padding-left:15px;padding-right:15px;}
...
img{max-width:100%;height:auto;transition:all .3s;}
figure img{transition:none;}
h2,h3,h4{margin:0 0 1em;font-family:Lato,sans-serif;font-weight:400;line-height:1.3;text-rendering:optimizeLegibility;text-shadow:none;-webkit-font-smoothing:antialiased;}
h2{font-size:1.8em;margin-bottom:.8em;}
h3{font-size:1.6em;margin-bottom:.8em;}
h4{font-size:1.4em;}
p{margin:0 0 1em;}
...
.fa-star-o:before{content:"\f006";}
[class^=icon-]:before{font-family:realty!important;font-style:normal!important;font-weight:400!important;font-variant:normal!important;text-transform:none!important;speak:none;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;}
.icon-arrow-right:before{content:"\73";}
.icon-facebook:before{content:"\28";}
.icon-google-plus:before{content:"\29";}
.icon-pinterest:before{content:"\2b";}
.icon-twitter:before{content:"\2c";}
.icon-share:before{content:"\60";}
.icon-video-camera:before{content:"\7e";}
[class^="iconmoon-"]{font-family:'iconmoon'!important;speak:none;font-style:normal;font-weight:normal;font-variant:normal;text-transform:none;line-height:1;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;}
.iconmoon-location:before{content:"\e903";}
.iconmoon-crop_free:before{content:"\e3c2";}
.iconmoon-directions_transit:before{content:"\e535";}
...
a{color:#000;}
h2,h3,h4{font-family:"Source Sans Pro";font-weight:400;color:#42484b;opacity:1;visibility:visible;-webkit-transition:opacity .24s ease-in-out;-moz-transition:opacity .24s ease-in-out;transition:opacity .24s ease-in-out;}
h2,h3,h4{opacity:0;}
h2,h3,h4{visibility:hidden;}
input[type='submit'],.property-item .property-excerpt::after,#pagination .page-numbers li a:hover,#pagination .page-numbers li span:hover,#pagination .page-numbers li i:hover{background-color:#000;}
input:focus,.form-control:focus,input:active,.form-control:active,.chosen-container .chosen-drop{border-color:#000;}
.property-item .property-title::after{background:none;}
.property-item .property-title .title{color:#000;}
h2,h3,h4{color:#000;}
...
@media (min-width:992px){
.top-header-links{float:right;}
.top-header-links .desktop{display:block;}
.top-header-links .mobile{display:none;}
}
